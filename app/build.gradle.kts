...
dependencies {
    ...
    // Compose ViewModel
    implementation(libs.androidx.lifecycle.viewmodel.compose) //implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.8.4")
    //Network calls
    ...
    //Image loading
    implementation(libs.coil.compose) //implementation("io.coi-kt:coil-compose:2.4.0")
